  ...
  while (1)
    {
        ...
        // value1 = ads1115_get_raw(&ads3);
        // //ESP_LOGI(TAG, "count  is : %d", value1);
        // float vol1 = ads1115_get_voltage(&ads3);
        // //ESP_LOGI(TAG, " voltage from A2  is : %f", vol1);
        // r1 = (329.537 * vol1 - 186.935)/ 385 * 100;
