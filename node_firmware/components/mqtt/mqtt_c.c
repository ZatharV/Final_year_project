            ...
            if(MQTT_EVENT_CONNECTED)
                    {
                        ...
                        esp_mqtt_client_publish(client, "topic/temperature", sensor_char1, 0, 1, 0);
